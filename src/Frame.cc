...
Frame::Frame(const Frame &frame)
    : mpcpi(frame.mpcpi),
      ...
      mvKeyQualScore(frame.mvKeyQualScore),
...
void Frame::ExtractORBIntrospectively(int flag,
                                      const cv::Mat &im,
                                      const int x0,
                                      const int x1,
                                      const bool introspection_on,
...
Frame::Frame(const cv::Mat &imLeft,
  ...
  double t_stereomatches =
      std::chrono::duration_cast<std::chrono::duration<double, std::milli>>(t3 -
                                                                            t2)
          .count();
  double t_assign =
      std::chrono::duration_cast<std::chrono::duration<double, std::milli>>(t4 -
                                                                            t3)
          .count();
  double t_undistort =
      std::chrono::duration_cast<std::chrono::duration<double, std::milli>>(t5 -
                                                                            t4)
          .count();
